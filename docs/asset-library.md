...
| Asset | Best fit | Files |
| --- | --- | --- |
| Rainy city alley | Night streets, mystery, reflective scenes | [`master`](../assets/backgrounds/rainy-city-alley.png), [`270×480`](../assets/backgrounds/rainy-city-alley-270x480.png) |
| Summer shrine | Fantasy, travel, summer, discovery | [`master`](../assets/backgrounds/summer-shrine.png), [`270×480`](../assets/backgrounds/summer-shrine-270x480.png) |

Both have open foreground space for character overlays. The smaller versions were scaled with nearest-neighbor filtering for the factory's default logical canvas. The original prompts were:
